...
function buildCharts(sample) {
  ...
  d3.json("static/js/data/samples.json").then((data) => {
    ...
    // 1. Create a variable that filters the metadata array for the object with the desired sample 
    ...
    var gaugeData = [{
      ...
      type: "indicator",
      mode: "gauge+number",
      title: {text: "<b> Belly Button Washing Frequency </b> <br></br><i> Scrubs Per Week </i>"},
      gauge: {
